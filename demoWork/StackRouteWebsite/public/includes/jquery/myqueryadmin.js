...
$(function (){
	...
	$('.list-op-users').on('click', function(){
		$('.admin-action-div').load('templates/adminOperations/manageUsers.html');
	});
	$('.list-op-forms').on('click', function(){
		$('.admin-action-div').load('templates/adminOperations/manageForms.html');
	});
});
